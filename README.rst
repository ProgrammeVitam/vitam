...
* "La Licence Ouverte V2" est compatible avec le `Creative Commons CC-By-SA 2.0 license <https://creativecommons.org/licenses/by-sa/2.0/>`_; Une copie de cette licence est disponible dans le fichier `Licence\_CC-By-SA\_2.0-en.txt <./Licence_CC-By-SA_2.0-en.txt>`_.
