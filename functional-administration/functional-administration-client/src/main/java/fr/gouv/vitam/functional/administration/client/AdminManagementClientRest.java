...
public class AdminManagementClientRest implements AdminManagementClient {
   ...
   //TODO : Refactorisation à réfléchir pour ne pas avoir une seule classe gérant tous les endpoints (formats, régles de gestions, contrat , etc)
    @Override
    public void checkFormat(InputStream stream) throws  ReferentialException {
