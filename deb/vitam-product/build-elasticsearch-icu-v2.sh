...
pushd ${WORKING_FOLDER}/vitam-elasticsearch-analysis-icu-v2/usr/share/elasticsearch/plugins/analysis-icu
...
dpkg-deb --build vitam-elasticsearch-analysis-icu-v2 ${WORKING_FOLDER}/target
