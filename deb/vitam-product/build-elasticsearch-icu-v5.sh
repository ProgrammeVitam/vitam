...
pushd ${WORKING_FOLDER}/vitam-elasticsearch-analysis-icu-v5/usr/share/elasticsearch/plugins/analysis-icu
...
dpkg-deb --build vitam-elasticsearch-analysis-icu-v5 ${WORKING_FOLDER}/target
