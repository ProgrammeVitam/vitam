...
A partir de SIP versant, nous devrons générer une réponse en format XML en utilisant les informations précisées dans le SEDA et l'information sur le workflow exécuté. 
