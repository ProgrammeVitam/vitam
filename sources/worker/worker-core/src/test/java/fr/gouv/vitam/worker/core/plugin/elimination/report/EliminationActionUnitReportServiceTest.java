...
import static fr.gouv.vitam.worker.core.plugin.elimination.report.EliminationActionUnitReportService.DISTINCT_REPORT_JSONL;
import static fr.gouv.vitam.worker.core.plugin.elimination.report.EliminationActionUnitReportService.UNIT_REPORT_JSONL;
...
public class EliminationActionUnitReportServiceTest {
    ...
    @InjectMocks
    private EliminationActionUnitReportService instance;
    ...
    public void exportUnits() throws Exception {
        ...
        assertThat(reportExportRequestArgumentCaptor.getValue().getFilename()).isEqualTo(UNIT_REPORT_JSONL);
    ...
    public void exportDistinctObjectGroups() throws Exception {
        ...
        ArgumentCaptor<ReportExportRequest> reportExportRequestArgumentCaptor =
            ArgumentCaptor.forClass(ReportExportRequest.class);
        verify(batchReportClient)
            .generateEliminationActionDistinctObjectGroupInUnitReport(eq(PROC_ID), eq("DELETED"),
