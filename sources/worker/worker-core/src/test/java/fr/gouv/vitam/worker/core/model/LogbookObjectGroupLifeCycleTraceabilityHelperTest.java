...
public class LogbookObjectGroupLifeCycleTraceabilityHelperTest {
    ...
    private static final String OBJECT_FILE =
        "LogbookLifeCycleTraceabilityHelperTest/object.txt";
    ...
    public void setUp() throws Exception {
        ...
        handlerIO =
            new HandlerIOImpl(workspaceClient, "Test", "workerId", Lists.newArrayList(objectId));
    ...
    public void should_correctly_save_data_and_compute_start_date_for_first_traceability() throws Exception {
        ...
        // Then
        assertThat(Files.size(Paths.get(zipFile.getPath()))).isEqualTo(21725L);
    }
