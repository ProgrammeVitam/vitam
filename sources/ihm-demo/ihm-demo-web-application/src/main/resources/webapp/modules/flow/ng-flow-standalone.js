...
(function(window, document, undefined) {'use strict';
  ...
  FlowChunk.prototype = {
    ...
    getParams: function () {
      return {
        "Flow-Chunk-Number": this.offset + 1,
        "Flow-Chunk-Size": this.flowObj.opts.chunkSize,
        "Flow-Current-Chunk-Size": this.endByte - this.startByte,
        "Flow-Total-Size": this.fileObj.size,
        "Flow-Identifier": this.fileObj.uniqueIdentifier,
        "Flow-Filename": this.fileObj.name,
        "Flow-Relative-Path": this.fileObj.relativePath,
        "Flow-Total-Chunks": this.fileObj.chunks.length
      };
    },
