...
export class ArchiveUnitComponent extends PageComponent {
    ...
    private fieldOptions = [
      ...
      {label: 'PersistentIdentifier.PersistentIdentifierType', value: 'PersistentIdentifier.PersistentIdentifierType'},
      {label: 'PersistentIdentifier.PersistentIdentifierOrigin', value: 'PersistentIdentifier.PersistentIdentifierOrigin'},
      {label: 'PersistentIdentifier.PersistentIdentifierReference', value: 'PersistentIdentifier.PersistentIdentifierReference'},
      {label: 'PersistentIdentifier.PersistentIdentifierContent', value: 'PersistentIdentifier.PersistentIdentifierContent'},
      ...
      {label: 'SigningInformation.SigningRole', value: 'SigningInformation.SigningRole'},
      {label: 'SigningInformation.DetachedSigningRole', value: 'SigningInformation.DetachedSigningRole'},
      {label: 'SigningInformation.SignatureDescription.Signer.Activity', value: 'SigningInformation.SignatureDescription.Signer.Activity'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthDate', value: 'SigningInformation.SignatureDescription.Signer.BirthDate'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthName', value: 'SigningInformation.SignatureDescription.Signer.BirthName'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Address', value: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Address'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthPlace.City', value: 'SigningInformation.SignatureDescription.Signer.BirthPlace.City'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Country', value: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Country'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Geogname', value: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Geogname'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthPlace.PostalCode', value: 'SigningInformation.SignatureDescription.Signer.BirthPlace.PostalCode'},
      {label: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Region', value: 'SigningInformation.SignatureDescription.Signer.BirthPlace.Region'},
      {label: 'SigningInformation.SignatureDescription.Signer.Corpname', value: 'SigningInformation.SignatureDescription.Signer.Corpname'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathDate', value: 'SigningInformation.SignatureDescription.Signer.DeathDate'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Address', value: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Address'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathPlace.City', value: 'SigningInformation.SignatureDescription.Signer.DeathPlace.City'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Country', value: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Country'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Geogname', value: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Geogname'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathPlace.PostalCode', value: 'SigningInformation.SignatureDescription.Signer.DeathPlace.PostalCode'},
      {label: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Region', value: 'SigningInformation.SignatureDescription.Signer.DeathPlace.Region'},
      {label: 'SigningInformation.SignatureDescription.Signer.FirstName', value: 'SigningInformation.SignatureDescription.Signer.FirstName'},
      {label: 'SigningInformation.SignatureDescription.Signer.FullName', value: 'SigningInformation.SignatureDescription.Signer.FullName'},
      {label: 'SigningInformation.SignatureDescription.Signer.Function', value: 'SigningInformation.SignatureDescription.Signer.Function'},
      {label: 'SigningInformation.SignatureDescription.Signer.Gender', value: 'SigningInformation.SignatureDescription.Signer.Gender'},
      {label: 'SigningInformation.SignatureDescription.Signer.GivenName', value: 'SigningInformation.SignatureDescription.Signer.GivenName'},
      {label: 'SigningInformation.SignatureDescription.Signer.Identifier', value: 'SigningInformation.SignatureDescription.Signer.Identifier'},
      {label: 'SigningInformation.SignatureDescription.Signer.Mandate', value: 'SigningInformation.SignatureDescription.Signer.Mandate'},
      {label: 'SigningInformation.SignatureDescription.Signer.Nationality', value: 'SigningInformation.SignatureDescription.Signer.Nationality'},
      {label: 'SigningInformation.SignatureDescription.Signer.Position', value: 'SigningInformation.SignatureDescription.Signer.Position'},
      {label: 'SigningInformation.SignatureDescription.Signer.Role', value: 'SigningInformation.SignatureDescription.Signer.Role'},
      {label: 'SigningInformation.SignatureDescription.Signer.SigningTime', value: 'SigningInformation.SignatureDescription.Signer.SigningTime'},
      {label: 'SigningInformation.SignatureDescription.Validator.Activity', value: 'SigningInformation.SignatureDescription.Validator.Activity'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthDate', value: 'SigningInformation.SignatureDescription.Validator.BirthDate'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthName', value: 'SigningInformation.SignatureDescription.Validator.BirthName'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Address', value: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Address'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthPlace.City', value: 'SigningInformation.SignatureDescription.Validator.BirthPlace.City'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Country', value: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Country'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Geogname', value: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Geogname'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthPlace.PostalCode', value: 'SigningInformation.SignatureDescription.Validator.BirthPlace.PostalCode'},
      {label: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Region', value: 'SigningInformation.SignatureDescription.Validator.BirthPlace.Region'},
      {label: 'SigningInformation.SignatureDescription.Validator.Corpname', value: 'SigningInformation.SignatureDescription.Validator.Corpname'}, 
      {label: 'SigningInformation.SignatureDescription.Validator.DeathDate', value: 'SigningInformation.SignatureDescription.Validator.DeathDate'},
      {label: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Address', value: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Address'},
      {label: 'SigningInformation.SignatureDescription.Validator.DeathPlace.City', value: 'SigningInformation.SignatureDescription.Validator.DeathPlace.City'},
      {label: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Country', value: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Country'},
      {label: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Geogname', value: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Geogname'},
      {label: 'SigningInformation.SignatureDescription.Validator.DeathPlace.PostalCode', value: 'SigningInformation.SignatureDescription.Validator.DeathPlace.PostalCode'},
      {label: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Region', value: 'SigningInformation.SignatureDescription.Validator.DeathPlace.Region'},
      {label: 'SigningInformation.SignatureDescription.Validator.FirstName', value: 'SigningInformation.SignatureDescription.Validator.FirstName'},
      {label: 'SigningInformation.SignatureDescription.Validator.FullName', value: 'SigningInformation.SignatureDescription.Validator.FullName'},
      {label: 'SigningInformation.SignatureDescription.Validator.Function', value: 'SigningInformation.SignatureDescription.Validator.Function'},
      {label: 'SigningInformation.SignatureDescription.Validator.Gender', value: 'SigningInformation.SignatureDescription.Validator.Gender'},
      {label: 'SigningInformation.SignatureDescription.Validator.GivenName', value: 'SigningInformation.SignatureDescription.Validator.GivenName'},
      {label: 'SigningInformation.SignatureDescription.Validator.Identifier', value: 'SigningInformation.SignatureDescription.Validator.Identifier'},
      {label: 'SigningInformation.SignatureDescription.Validator.Mandate', value: 'SigningInformation.SignatureDescription.Validator.Mandate'},
      {label: 'SigningInformation.SignatureDescription.Validator.Nationality', value: 'SigningInformation.SignatureDescription.Validator.Nationality'},
      {label: 'SigningInformation.SignatureDescription.Validator.Position', value: 'SigningInformation.SignatureDescription.Validator.Position'},
      {label: 'SigningInformation.SignatureDescription.Validator.Role', value: 'SigningInformation.SignatureDescription.Validator.Role'},
      {label: 'SigningInformation.SignatureDescription.Validator.ValidationTime', value: 'SigningInformation.SignatureDescription.Validator.ValidationTime'},
      {label: 'SigningInformation.SignatureDescription.SigningType', value: 'SigningInformation.SignatureDescription.SigningType'},
      {label: 'SigningInformation.TimestampingInformation.TimeStamp', value: 'SigningInformation.TimestampingInformation.TimeStamp'},
      {label: 'SigningInformation.TimestampingInformation.AdditionalTimestampingInformation', value: 'SigningInformation.TimestampingInformation.AdditionalTimestampingInformation'},
      {label: 'SigningInformation.AdditionalProof.AdditionalProofInformation', value: 'SigningInformation.AdditionalProof.AdditionalProofInformation'},
