 ...
 * under the License.
 * Fork from https://github.com/gaetancollaud/elasticsearch-metrics-reporter-java/blob/elasticsearch6/src/main/java/org/elasticsearch/metrics/ElasticsearchReporter.java
 * to be elasticsearch 6 compliant
 */
