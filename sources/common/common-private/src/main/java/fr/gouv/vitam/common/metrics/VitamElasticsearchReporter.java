...
/**
 * A fork of the {@link ElasticsearchReporter}
...
public class VitamElasticsearchReporter extends ScheduledReporter {
    ...
    public static class Builder {
        ...
        public VitamElasticsearchReporter build() throws IOException {
            return new VitamElasticsearchReporter(registry,
                    hosts,
                    timeout,
                    index,
                    indexDateFormat,
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(VitamElasticsearchReporter.class);
    ...
    public VitamElasticsearchReporter(MetricRegistry registry, String[] hosts, int timeout,
