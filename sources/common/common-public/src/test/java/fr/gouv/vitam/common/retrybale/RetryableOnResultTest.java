package fr.gouv.vitam.common.retrybale;
...
public class RetryableOnResultTest {
    ...
    public void should_retry_on_predicate() {
        ...
        RetryableOnResult<Integer, VitamRuntimeException>
            retryableOnResult = new RetryableOnResult<>(parameters, r -> r <= 3);
    ...
    public void should_retry_on_predicate_times() {
        ...
        RetryableOnResult<Integer, VitamRuntimeException>
            retryableOnResult = new RetryableOnResult<>(parameters, shouldRetryOnPredicate);
