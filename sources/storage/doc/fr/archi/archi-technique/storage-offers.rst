...
- une seule offre de stockage, appelée storage-offer-default. Cependant, elle permet d'etre de deux types différents
: système de fichier ou swift
- un seul driver (utilisée par storage-offer-default) appelé default-driver. Il permet d'uliser l'offre par défaut
