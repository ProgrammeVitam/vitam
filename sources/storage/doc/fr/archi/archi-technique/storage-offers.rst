...
- une seule offre de stockage, appelée vitam-offer, qui supporte plusieurs types de persistance : système de fichiers, Swift, S3 ou sur bandes magnétiques.
- un seul driver (utilisé par storage-offer-default) appelé vitam-driver. Il permet d'utiliser l'offre par défaut qu'elle soit en mode swift, s3, système de fichiers ou sur bandes magnétiques.
