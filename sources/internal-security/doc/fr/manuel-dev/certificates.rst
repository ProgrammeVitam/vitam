...
Plusieurs opérations sont supportées pour la gestion des certificats SIA et personnels. Les certificats sont stockées dans la base Identity dans les collections Certificate et PersonalCertificate respectivement.
