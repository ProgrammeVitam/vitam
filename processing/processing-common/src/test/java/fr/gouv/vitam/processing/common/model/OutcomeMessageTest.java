...
public class OutcomeMessageTest {
    ...
    public void testEnum() {
        assertEquals(OutcomeMessage.CHECK_CONFORMITY_OK.value(), "Contrôle de conformité des objets réalisé avec succès");
        assertEquals(OutcomeMessage.CHECK_CONFORMITY_KO.value(), "Erreur de contrôle de conformité des objets");
        assertEquals(OutcomeMessage.CHECK_OBJECT_NUMBER_OK.value(), "Contrôle du nombre des objets réalisé avec succès");
