...
if [ -d "${VITAM_GIT_REPO}/.git" ] ; then
	...
	docker run -d -v "${VITAM_GIT_REPO}:/code" -v "${HOME}/.m2:/root/.m2" -p 8082:8082 -p 9200:9200 -p 9300:9300 -p 9201:9201 -p 9301:9301 -p 27017:27017 -p 10514:10514 -p 8000-8010:8000-8010 -p 8100-8110:8100-8110 -p 8200-8210:8200-8210 -p 8300-8310:8300-8310 --cap-add=SYS_ADMIN --security-opt seccomp=unconfined --name=vitam-rpm-dev docker.programmevitam.fr/vitam/dev-rpm-base
	echo "Opening console..."
	docker exec -it vitam-rpm-dev bash
	echo "Stopping container..."
	docker stop vitam-rpm-dev
	echo "Container stopped !"
	echo "Hint : don't forget to run docker rm dev-rpm-base to remove the existing container"
