...
public class UnitResource {
	...
	public UnitResource(MetaDataConfiguration configuration) {
		// TODO REVIEW should not create the implementation directly but using the method as constructor
	...
	public Response insertUnit(String insertRequest) {
		...
		try {
			...
			// TODO REVIEW since you parse it, parse it first then pass it to insertUnit as a Json
