...
Source0:       https://github.com/richardlehane/siegfried/releases/download/v%{version}/siegfried_1-11-4_linux64.zip
Source1:       https://github.com/richardlehane/siegfried/releases/download/v%{version}/data_1-11-4.zip
