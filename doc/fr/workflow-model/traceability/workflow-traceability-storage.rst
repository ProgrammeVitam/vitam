Création de journal sécurisé des journaux des écritures 
#########################################################
...
+ **Règle** : création de journal sécurisé des journaux des écritures 
...
+ **Status** :
	...
	* KO : pas de cas KO
	* FATAL : une erreur technique est survenue lors de l'horodatage (STP_STORAGE_SECURISATION.FATAL = Erreur technique lors du processus de sécurisation du journal des écritures)
