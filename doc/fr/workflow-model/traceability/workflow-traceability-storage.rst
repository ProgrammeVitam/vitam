...
* **Status** :
	...
	* KO : pas de cas KO
	* FATAL : une erreur fatale est survenue lors de l'horodatage (STP_STORAGE_SECURISATION.FATAL = Erreur fatale lors du processus de sécurisation du journal des écritures)
