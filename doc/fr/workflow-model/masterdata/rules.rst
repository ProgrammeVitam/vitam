...
Processus d'administration d'un référentiel de règles de gestion (IMPORT_RULES)
===================================================================================
...
Processus d'enregistrement du fichier d'import du référentiel des règles de gestion IMPORT_RULES_BACKUP_CSV (RulesManagerFileImpl.java)
-------------------------------------------------------------------------------------------------------------------------------------------
...
Sauvegarde du JSON IMPORT_RULES_BACKUP (RulesManagerFileImpl.java)
----------------------------------------------------------------------
