...
+ **Règle** : sauvegarde des métadonnées liées aux unités archivistiques ainsi que leur journaux de cycle de vie sur les offres de stockage en fonction de la stratégie de stockage
