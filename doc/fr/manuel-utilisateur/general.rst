...
Chaque section comprend plusieurs sous-menus permettant de naviguer sur les différentes pages et accessibles en cliquant sur la flèche au dessous du titre de la section  permettant de naviguer sur les différentes pages.
...
Pour les cas WARNING, la ligne ne change pas de couleur mais le texte est affiché en orange et un pictogramme en forme de point d'exclamation est présent.
...
.. image :: images/ajouter_au_panier.png

- Via le panier directement : le bouton "Ajouter des unités archivistiques" permet d'accèder directement à la page de recherche, afin d'ajouter des unités archivistiques à la sélection. 
...
.. Note :: un clic sur chaque ligne permet de retourner à la page de détail de l'unité archivistique, de la même façon que via la page de recherche. Les unités archivistiques de la descendance ne sont pas sélectionnables individuellement. 
...
Il est possible de créer une sélection pour travailler sur certaines unités archivistiques dans le panier uniquement.
...
.. Note :: si aucune unité archivistique n'est sélectionnée, les boutons correspondants aux actions relatives à la sélection uniquement seront grisés et les actions ne seront disponibles que pour la totalité du panier. 
