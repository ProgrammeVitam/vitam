...
Les fichiers de déploiement sont disponibles dans la version VITAM livrée, dans le sous-répertoire |repertoire_deploiement| . Concernant l'installation, ils se déclinent en 2 parties :
