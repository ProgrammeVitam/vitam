...
* Requêtable : le SAE doit fournir un service de recherche, tout comme un SGBD (système de gestion de bases de données) fournit une interface de requêtes des bases qu'il héberge
