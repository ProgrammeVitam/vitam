...
- Que l'ensemble des tâches planifiées soient stoppées
- Qu'aucun `workflow` ne soit ni en cours, ni en statut **FATAL**
...
- Que la solution logicielle :term:`VITAM` fonctionne normalement
- Que l'ensemble des tâches planifiées soient bien redémarrées (les redémarrer, le cas échéant)
- Qu'aucun `workflow` ne soit en statut **FATAL**
