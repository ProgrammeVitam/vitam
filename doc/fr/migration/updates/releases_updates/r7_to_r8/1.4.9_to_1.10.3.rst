...
.. caution:: La migration doit être réalisée en partant de la version la plus récente de la version « R7 » (1.4.9).
...
La montée de version 1.4.9 (« R7.9 ») vers 1.10.3 (« R8.3 ») comprend une montée de version de MongoDB de la version 3.4 à la version 4.0. 
...
Dans le cadre d'une montée de version 1.4.9 (« R7.9 ») vers 1.10.3 (« R8.3 »), il est nécessaire d'appliquer un `playbook` de migration de données à l'issue de réinstallation de la solution logicielle :term:`VITAM`. 
